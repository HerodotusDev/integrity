...
use integrity::air::layouts::dex::autogenerated::eval_composition_polynomial_inner;
#[cfg(feature: 'monolith')]
use integrity::air::layouts::dex::autogenerated::eval_oods_polynomial_inner as eval_oods_polynomial_inner_;
use integrity::air::layouts::dex::constants::{
    ECDSA_BUILTIN_RATIO, ECDSA_BUILTIN_REPETITIONS, PEDERSEN_BUILTIN_RATIO,
    PEDERSEN_BUILTIN_REPETITIONS, PUBLIC_MEMORY_STEP, segments,
};
use integrity::air::layouts::dex::global_values::{
