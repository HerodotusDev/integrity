...
use integrity::air::constants::{SHIFT_POINT_X, SHIFT_POINT_Y};
use integrity::air::diluted::get_diluted_product;
use integrity::air::layouts::recursive_with_poseidon::autogenerated::eval_composition_polynomial_inner;
#[cfg(feature: 'monolith')]
use integrity::air::layouts::recursive_with_poseidon::autogenerated::eval_oods_polynomial_inner as eval_oods_polynomial_inner_;
use integrity::air::layouts::recursive_with_poseidon::constants::{
    DILUTED_N_BITS, DILUTED_SPACING, PEDERSEN_BUILTIN_RATIO, PEDERSEN_BUILTIN_REPETITIONS,
    POSEIDON_RATIO, PUBLIC_MEMORY_STEP, segments,
};
use integrity::air::layouts::recursive_with_poseidon::global_values::{
