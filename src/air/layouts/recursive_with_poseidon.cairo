...
impl RecursiveWithPoseidonAIRCompositionImpl of AIRComposition<InteractionElements, PublicInput> {
    fn eval_composition_polynomial(
        ...
        let global_values = GlobalValues {
            ...
            pedersen_points_x,
            pedersen_points_y,
            poseidon_poseidon_full_round_key0: poseidon_poseidon_full_round_key0,
            poseidon_poseidon_full_round_key1: poseidon_poseidon_full_round_key1,
            poseidon_poseidon_full_round_key2: poseidon_poseidon_full_round_key2,
            poseidon_poseidon_partial_round_key0: poseidon_poseidon_partial_round_key0,
            poseidon_poseidon_partial_round_key1: poseidon_poseidon_partial_round_key1,
