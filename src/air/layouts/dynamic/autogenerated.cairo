...
fn check_asserts(dynamic_params: DynamicParams, stark_domains: @StarkDomains) {
    ...
    // Offset of cpu/decode/mem_inst is too big.
     x = (16 * dynamic_params.cpu_component_step.into() - dynamic_params.cpu_decode_mem_inst_suboffset.into() * dynamic_params.memory_units_row_ratio.into()) - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset of cpu/decode/off0 is too big.
     x = (16 * dynamic_params.cpu_component_step.into() - dynamic_params.cpu_decode_off0_suboffset.into() * dynamic_params.range_check_units_row_ratio.into()) - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset of cpu/decode/off1 is too big.
     x = (16 * dynamic_params.cpu_component_step.into() - dynamic_params.cpu_decode_off1_suboffset.into() * dynamic_params.range_check_units_row_ratio.into()) - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset of cpu/decode/off2 is too big.
     x = (16 * dynamic_params.cpu_component_step.into() - dynamic_params.cpu_decode_off2_suboffset.into() * dynamic_params.range_check_units_row_ratio.into()) - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset of cpu/operands/mem_dst is too big.
     x = (16 * dynamic_params.cpu_component_step.into() - dynamic_params.cpu_operands_mem_dst_suboffset.into() * dynamic_params.memory_units_row_ratio.into()) - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset of cpu/operands/mem_op0 is too big.
     x = (16 * dynamic_params.cpu_component_step.into() - dynamic_params.cpu_operands_mem_op0_suboffset.into() * dynamic_params.memory_units_row_ratio.into()) - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset of cpu/operands/mem_op1 is too big.
     x = (16 * dynamic_params.cpu_component_step.into() - dynamic_params.cpu_operands_mem_op1_suboffset.into() * dynamic_params.memory_units_row_ratio.into()) - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset of orig/public_memory is too big.
     x = (8 * dynamic_params.memory_units_row_ratio.into() - dynamic_params.orig_public_memory_suboffset.into() * dynamic_params.memory_units_row_ratio.into()) - 1;
    assert_range_u128_from_u256(x);
    
    // Uses_pedersen_builtin should be a boolean.
    assert (dynamic_params.uses_pedersen_builtin.into() * dynamic_params.uses_pedersen_builtin.into() - dynamic_params.uses_pedersen_builtin.into() == 0 , 'Invalid value');
    // Uses_range_check_builtin should be a boolean.
    assert (dynamic_params.uses_range_check_builtin.into() * dynamic_params.uses_range_check_builtin.into() - dynamic_params.uses_range_check_builtin.into() == 0 , 'Invalid value');
    // Uses_ecdsa_builtin should be a boolean.
    assert (dynamic_params.uses_ecdsa_builtin.into() * dynamic_params.uses_ecdsa_builtin.into() - dynamic_params.uses_ecdsa_builtin.into() == 0 , 'Invalid value');
    // Uses_bitwise_builtin should be a boolean.
    assert (dynamic_params.uses_bitwise_builtin.into() * dynamic_params.uses_bitwise_builtin.into() - dynamic_params.uses_bitwise_builtin.into() == 0 , 'Invalid value');
    // Uses_ec_op_builtin should be a boolean.
    assert (dynamic_params.uses_ec_op_builtin.into() * dynamic_params.uses_ec_op_builtin.into() - dynamic_params.uses_ec_op_builtin.into() == 0 , 'Invalid value');
    // Uses_keccak_builtin should be a boolean.
    assert (dynamic_params.uses_keccak_builtin.into() * dynamic_params.uses_keccak_builtin.into() - dynamic_params.uses_keccak_builtin.into() == 0 , 'Invalid value');
    // Uses_poseidon_builtin should be a boolean.
    assert (dynamic_params.uses_poseidon_builtin.into() * dynamic_params.uses_poseidon_builtin.into() - dynamic_params.uses_poseidon_builtin.into() == 0 , 'Invalid value');
    // Uses_range_check96_builtin should be a boolean.
    assert (dynamic_params.uses_range_check96_builtin.into() * dynamic_params.uses_range_check96_builtin.into() - dynamic_params.uses_range_check96_builtin.into() == 0 , 'Invalid value');
    // Uses_add_mod_builtin should be a boolean.
    assert (dynamic_params.uses_add_mod_builtin.into() * dynamic_params.uses_add_mod_builtin.into() - dynamic_params.uses_add_mod_builtin.into() == 0 , 'Invalid value');
    // Uses_mul_mod_builtin should be a boolean.
    assert (dynamic_params.uses_mul_mod_builtin.into() * dynamic_params.uses_mul_mod_builtin.into() - dynamic_params.uses_mul_mod_builtin.into() == 0 , 'Invalid value');
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.range_check16_pool_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.cpu_decode_opcode_range_check_column_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.cpu_operands_ops_mul_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.cpu_update_registers_update_pc_tmp0_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.cpu_update_registers_update_pc_tmp1_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.memory_sorted_addr_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.memory_sorted_value_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.range_check16_sorted_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.diluted_check_permuted_values_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.pedersen_hash0_ec_subset_sum_partial_sum_x_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.pedersen_hash0_ec_subset_sum_partial_sum_x_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.pedersen_hash0_ec_subset_sum_partial_sum_y_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.pedersen_hash0_ec_subset_sum_partial_sum_y_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.pedersen_hash0_ec_subset_sum_slope_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.pedersen_hash0_ec_subset_sum_selector_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.pedersen_hash0_ec_subset_sum_bit_unpacking_prod_ones196_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.pedersen_hash0_ec_subset_sum_bit_unpacking_prod_ones196_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.pedersen_hash0_ec_subset_sum_bit_unpacking_prod_ones192_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.pedersen_hash0_ec_subset_sum_bit_unpacking_prod_ones192_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_key_points_x_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_key_points_y_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_doubling_slope_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_exponentiate_generator_partial_sum_x_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.ecdsa_signature0_exponentiate_generator_partial_sum_x_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_exponentiate_generator_partial_sum_y_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.ecdsa_signature0_exponentiate_generator_partial_sum_y_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_exponentiate_generator_slope_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.ecdsa_signature0_exponentiate_generator_slope_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_exponentiate_generator_selector_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.ecdsa_signature0_exponentiate_generator_selector_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_exponentiate_generator_x_diff_inv_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.ecdsa_signature0_exponentiate_generator_x_diff_inv_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_exponentiate_key_partial_sum_x_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length - dynamic_params.ecdsa_signature0_exponentiate_key_partial_sum_x_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_exponentiate_key_partial_sum_y_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.ecdsa_signature0_exponentiate_key_partial_sum_y_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_exponentiate_key_slope_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_exponentiate_key_selector_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length - dynamic_params.ecdsa_signature0_exponentiate_key_selector_offset.into() -
        1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_exponentiate_key_x_diff_inv_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.ecdsa_signature0_exponentiate_key_x_diff_inv_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_add_results_slope_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_add_results_inv_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_extract_r_slope_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_extract_r_inv_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.ecdsa_signature0_z_inv_column.into() -
        1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_r_w_inv_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ecdsa_signature0_q_x_squared_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.ec_op_doubled_points_x_column.into() -
        1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.ec_op_doubled_points_y_column.into() -
        1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.ec_op_doubling_slope_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ec_op_ec_subset_sum_partial_sum_x_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ec_op_ec_subset_sum_partial_sum_y_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ec_op_ec_subset_sum_slope_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ec_op_ec_subset_sum_selector_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ec_op_ec_subset_sum_x_diff_inv_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ec_op_ec_subset_sum_bit_unpacking_prod_ones196_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.ec_op_ec_subset_sum_bit_unpacking_prod_ones196_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.ec_op_ec_subset_sum_bit_unpacking_prod_ones192_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.ec_op_ec_subset_sum_bit_unpacking_prod_ones192_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.keccak_keccak_parse_to_diluted_reshaped_intermediate_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.keccak_keccak_parse_to_diluted_reshaped_intermediate_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.keccak_keccak_parse_to_diluted_final_reshaped_input_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.keccak_keccak_parse_to_diluted_final_reshaped_input_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.keccak_keccak_parse_to_diluted_cumulative_sum_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.keccak_keccak_parse_to_diluted_cumulative_sum_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.keccak_keccak_rotated_parity0_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.keccak_keccak_rotated_parity1_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.keccak_keccak_rotated_parity2_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.keccak_keccak_rotated_parity3_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.keccak_keccak_rotated_parity4_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.poseidon_poseidon_full_rounds_state0_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.poseidon_poseidon_full_rounds_state1_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.poseidon_poseidon_full_rounds_state2_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.poseidon_poseidon_full_rounds_state0_squared_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.poseidon_poseidon_full_rounds_state0_squared_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.poseidon_poseidon_full_rounds_state1_squared_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.poseidon_poseidon_full_rounds_state1_squared_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.poseidon_poseidon_full_rounds_state2_squared_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.poseidon_poseidon_full_rounds_state2_squared_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.poseidon_poseidon_partial_rounds_state0_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.poseidon_poseidon_partial_rounds_state1_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.poseidon_poseidon_partial_rounds_state0_squared_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.poseidon_poseidon_partial_rounds_state0_squared_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() -
        dynamic_params.poseidon_poseidon_partial_rounds_state1_squared_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Offset must be smaller than trace length.
     x = trace_length -
        dynamic_params.poseidon_poseidon_partial_rounds_state1_squared_offset.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.add_mod_sub_p_bit_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.add_mod_carry1_bit_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.add_mod_carry2_bit_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.add_mod_carry3_bit_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.add_mod_carry1_sign_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.add_mod_carry2_sign_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() - dynamic_params.add_mod_carry3_sign_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() + dynamic_params.num_columns_second.into() -
        dynamic_params.memory_multi_column_perm_perm_cum_prod0_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() + dynamic_params.num_columns_second.into() -
        dynamic_params.range_check16_perm_cum_prod0_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() + dynamic_params.num_columns_second.into() -
        dynamic_params.diluted_check_cumulative_value_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    // Column index out of range.
     x = dynamic_params.num_columns_first.into() + dynamic_params.num_columns_second.into() -
        dynamic_params.diluted_check_permutation_cum_prod0_column.into() - 1;
    assert_range_u128_from_u256(x);
    ...
    if (dynamic_params.uses_pedersen_builtin.into() != 0) {
        ...
        // Offset of pedersen/input0 is too big.
         x = dynamic_params.pedersen_builtin_row_ratio.into()  - 
                dynamic_params.pedersen_input0_suboffset.into() * dynamic_params.memory_units_row_ratio.into()
             -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of pedersen/input1 is too big.
         x = dynamic_params.pedersen_builtin_row_ratio.into()  - 
                dynamic_params.pedersen_input1_suboffset.into() * dynamic_params.memory_units_row_ratio.into()
             -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of pedersen/output is too big.
         x = dynamic_params.pedersen_builtin_row_ratio.into()  - 
                dynamic_params.pedersen_output_suboffset.into() * dynamic_params.memory_units_row_ratio.into()
             -  1;
        assert_range_u128_from_u256(x);         
    }
    ...
    if (dynamic_params.uses_range_check_builtin.into() != 0) {
        ...
        // Offset of range_check_builtin/mem is too big.
         x = dynamic_params.range_check_builtin_row_ratio.into() - dynamic_params.range_check_builtin_mem_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of range_check_builtin/inner_range_check is too big.
         x = trace_length - dynamic_params.range_check_builtin_inner_range_check_suboffset.into() -
            1;
        assert_range_u128_from_u256(x);
        
        // Offset of range_check_builtin/inner_range_check is too big.
         x = dynamic_params.range_check_builtin_row_ratio.into() / 8 - dynamic_params.range_check_builtin_inner_range_check_suboffset.into() * dynamic_params.range_check_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
    ...
    if (dynamic_params.uses_ecdsa_builtin.into() != 0) {
        ...
        // Offset of ecdsa/pubkey is too big.
         x = dynamic_params.ecdsa_builtin_row_ratio.into() - dynamic_params.ecdsa_pubkey_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of ecdsa/message is too big.
         x = dynamic_params.ecdsa_builtin_row_ratio.into() - dynamic_params.ecdsa_message_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
    }
    ...
    if (dynamic_params.uses_bitwise_builtin.into() != 0) {
        ...
        // Offset of bitwise/var_pool is too big.
         x = dynamic_params.bitwise_row_ratio.into() / 4 - dynamic_params.bitwise_var_pool_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of bitwise/x_or_y is too big.
         x = dynamic_params.bitwise_row_ratio.into() - dynamic_params.bitwise_x_or_y_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of bitwise/diluted_var_pool is too big.
         x = dynamic_params.bitwise_row_ratio.into() / 64 - dynamic_params.bitwise_diluted_var_pool_suboffset.into() * dynamic_params.diluted_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of bitwise/trim_unpacking192 is too big.
         x = dynamic_params.bitwise_row_ratio.into() - dynamic_params.bitwise_trim_unpacking192_suboffset.into() * dynamic_params.diluted_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of bitwise/trim_unpacking193 is too big.
         x = dynamic_params.bitwise_row_ratio.into() - dynamic_params.bitwise_trim_unpacking193_suboffset.into() * dynamic_params.diluted_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of bitwise/trim_unpacking194 is too big.
         x = dynamic_params.bitwise_row_ratio.into() - dynamic_params.bitwise_trim_unpacking194_suboffset.into() * dynamic_params.diluted_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of bitwise/trim_unpacking195 is too big.
         x = dynamic_params.bitwise_row_ratio.into() - dynamic_params.bitwise_trim_unpacking195_suboffset.into() * dynamic_params.diluted_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
    }
    ...
    if (dynamic_params.uses_ec_op_builtin.into() != 0) {
        ...
        // Offset of ec_op/p_x is too big.
         x = dynamic_params.ec_op_builtin_row_ratio.into() - dynamic_params.ec_op_p_x_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of ec_op/p_y is too big.
         x = dynamic_params.ec_op_builtin_row_ratio.into() - dynamic_params.ec_op_p_y_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of ec_op/q_x is too big.
         x = dynamic_params.ec_op_builtin_row_ratio.into() - dynamic_params.ec_op_q_x_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of ec_op/q_y is too big.
         x = dynamic_params.ec_op_builtin_row_ratio.into() - dynamic_params.ec_op_q_y_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of ec_op/m is too big.
         x = dynamic_params.ec_op_builtin_row_ratio.into() - dynamic_params.ec_op_m_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of ec_op/r_x is too big.
         x = dynamic_params.ec_op_builtin_row_ratio.into() - dynamic_params.ec_op_r_x_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of ec_op/r_y is too big.
         x = dynamic_params.ec_op_builtin_row_ratio.into() - dynamic_params.ec_op_r_y_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
    ...
    if (dynamic_params.uses_keccak_builtin.into() != 0) {
        ...
        // Offset of keccak/input_output is too big.
         x = dynamic_params.keccak_row_ratio.into() / 16 - dynamic_params.keccak_input_output_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of keccak/keccak/diluted_column0 is too big.
         x = dynamic_params.keccak_row_ratio.into() / 4096 - dynamic_params.keccak_keccak_diluted_column0_suboffset.into() * dynamic_params.diluted_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of keccak/keccak/diluted_column1 is too big.
         x = dynamic_params.keccak_row_ratio.into() / 4096 - dynamic_params.keccak_keccak_diluted_column1_suboffset.into() * dynamic_params.diluted_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of keccak/keccak/diluted_column2 is too big.
         x = dynamic_params.keccak_row_ratio.into() / 4096 - dynamic_params.keccak_keccak_diluted_column2_suboffset.into() * dynamic_params.diluted_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of keccak/keccak/diluted_column3 is too big.
         x = dynamic_params.keccak_row_ratio.into() / 4096 - dynamic_params.keccak_keccak_diluted_column3_suboffset.into() * dynamic_params.diluted_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
    }
    ...
    if (dynamic_params.uses_poseidon_builtin.into() != 0) {
        ...
        // Offset of poseidon/param_0/input_output is too big.
         x = dynamic_params.poseidon_row_ratio.into() / 2 - dynamic_params.poseidon_param_0_input_output_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of poseidon/param_1/input_output is too big.
         x = dynamic_params.poseidon_row_ratio.into() / 2 - dynamic_params.poseidon_param_1_input_output_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of poseidon/param_2/input_output is too big.
         x = dynamic_params.poseidon_row_ratio.into() / 2 - dynamic_params.poseidon_param_2_input_output_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);         
    }
    ...
    if (dynamic_params.uses_range_check96_builtin.into() != 0) {
        ...
        // Offset of range_check96_builtin/mem is too big.
         x = dynamic_params.range_check96_builtin_row_ratio.into() - dynamic_params.range_check96_builtin_mem_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of range_check96_builtin/inner_range_check0 is too big.
         x = trace_length -
            dynamic_params.range_check96_builtin_inner_range_check0_suboffset.into() - 1;
        assert_range_u128_from_u256(x);
        
        // Offset of range_check96_builtin/inner_range_check0 is too big.
         x = dynamic_params.range_check96_builtin_row_ratio.into() - dynamic_params.range_check96_builtin_inner_range_check0_suboffset.into() * dynamic_params.range_check_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of range_check96_builtin/inner_range_check1 is too big.
         x = trace_length -
            dynamic_params.range_check96_builtin_inner_range_check1_suboffset.into() - 1;
        assert_range_u128_from_u256(x);
        
        // Offset of range_check96_builtin/inner_range_check1 is too big.
         x = dynamic_params.range_check96_builtin_row_ratio.into() - dynamic_params.range_check96_builtin_inner_range_check1_suboffset.into() * dynamic_params.range_check_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of range_check96_builtin/inner_range_check2 is too big.
         x = trace_length -
            dynamic_params.range_check96_builtin_inner_range_check2_suboffset.into() - 1;
        assert_range_u128_from_u256(x);
        
        // Offset of range_check96_builtin/inner_range_check2 is too big.
         x = dynamic_params.range_check96_builtin_row_ratio.into() - dynamic_params.range_check96_builtin_inner_range_check2_suboffset.into() * dynamic_params.range_check_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of range_check96_builtin/inner_range_check3 is too big.
         x = trace_length -
            dynamic_params.range_check96_builtin_inner_range_check3_suboffset.into() - 1;
        assert_range_u128_from_u256(x);
        
        // Offset of range_check96_builtin/inner_range_check3 is too big.
         x = dynamic_params.range_check96_builtin_row_ratio.into() - dynamic_params.range_check96_builtin_inner_range_check3_suboffset.into() * dynamic_params.range_check_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of range_check96_builtin/inner_range_check4 is too big.
         x = trace_length -
            dynamic_params.range_check96_builtin_inner_range_check4_suboffset.into() - 1;
        assert_range_u128_from_u256(x);
        
        // Offset of range_check96_builtin/inner_range_check4 is too big.
         x = dynamic_params.range_check96_builtin_row_ratio.into() - dynamic_params.range_check96_builtin_inner_range_check4_suboffset.into() * dynamic_params.range_check_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of range_check96_builtin/inner_range_check5 is too big.
         x = trace_length -
            dynamic_params.range_check96_builtin_inner_range_check5_suboffset.into() - 1;
        assert_range_u128_from_u256(x);
        
        // Offset of range_check96_builtin/inner_range_check5 is too big.
         x = dynamic_params.range_check96_builtin_row_ratio.into() - dynamic_params.range_check96_builtin_inner_range_check5_suboffset.into() * dynamic_params.range_check_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
    ...
    if (dynamic_params.uses_add_mod_builtin.into() != 0) {
        ...
        // Offset of add_mod/p0 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_p0_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/p1 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_p1_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/p2 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_p2_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/p3 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_p3_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/values_ptr is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_values_ptr_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/offsets_ptr is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_offsets_ptr_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/n is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_n_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/a_offset is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_a_offset_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/b_offset is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_b_offset_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/c_offset is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_c_offset_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/a0 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_a0_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/a1 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_a1_suboffset.into() *  dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/a2 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_a2_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/a3 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_a3_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/b0 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_b0_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/b1 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_b1_suboffset.into() *  dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/b2 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_b2_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/b3 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_b3_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/c0 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_c0_suboffset.into() *  dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/c1 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_c1_suboffset.into() *  dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/c2 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_c2_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of add_mod/c3 is too big.
         x = dynamic_params.add_mod_row_ratio.into() - dynamic_params.add_mod_c3_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
    }
    ...
    if (dynamic_params.uses_mul_mod_builtin.into() != 0) {
        ...
        // Offset of mul_mod/p0 is too big.
         x = dynamic_params.mul_mod_row_ratio.into() - dynamic_params.mul_mod_p0_suboffset.into() * dynamic_params.memory_units_row_ratio.into() - 1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/p1 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_p1_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/p2 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_p2_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/p3 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_p3_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/values_ptr is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - 
                dynamic_params.mul_mod_values_ptr_suboffset.into() * dynamic_params.memory_units_row_ratio.into()
             -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/offsets_ptr is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - 
                dynamic_params.mul_mod_offsets_ptr_suboffset.into() * dynamic_params.memory_units_row_ratio.into()
             -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/n is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_n_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/a_offset is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - 
                dynamic_params.mul_mod_a_offset_suboffset.into() * dynamic_params.memory_units_row_ratio.into()
             -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/b_offset is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - 
                dynamic_params.mul_mod_b_offset_suboffset.into() * dynamic_params.memory_units_row_ratio.into()
             -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/c_offset is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - 
                dynamic_params.mul_mod_c_offset_suboffset.into() * dynamic_params.memory_units_row_ratio.into()
             -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/a0 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_a0_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/a1 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_a1_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/a2 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_a2_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/a3 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_a3_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/b0 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_b0_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/b1 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_b1_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/b2 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_b2_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/b3 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_b3_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/c0 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_c0_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/c1 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_c1_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/c2 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_c2_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
        ...
        // Offset of mul_mod/c3 is too big.
         x = dynamic_params.mul_mod_row_ratio.into()  - dynamic_params.mul_mod_c3_suboffset.into() * dynamic_params.memory_units_row_ratio.into() -  1;
        assert_range_u128_from_u256(x);
