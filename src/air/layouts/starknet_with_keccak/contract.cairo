...
mod LayoutCompositionPart1Contract {
    use integrity::air::layouts::starknet_with_keccak::autogenerated::eval_composition_polynomial_inner_part1;
    use integrity::air::layouts::starknet_with_keccak::global_values::GlobalValues;
    use starknet::ContractAddress;
...
mod LayoutCompositionPart2Contract {
    use integrity::air::layouts::starknet_with_keccak::autogenerated::eval_composition_polynomial_inner_part2;
    use integrity::air::layouts::starknet_with_keccak::global_values::GlobalValues;
    use starknet::ContractAddress;
    use super::ILayoutCompositionContract;
...
mod LayoutCompositionPart3Contract {
    use integrity::air::layouts::starknet_with_keccak::autogenerated::eval_composition_polynomial_inner_part3;
    use integrity::air::layouts::starknet_with_keccak::global_values::GlobalValues;
    use starknet::ContractAddress;
    use super::ILayoutCompositionContract;
...
mod LayoutOodsContract {
    use integrity::air::layouts::starknet_with_keccak::autogenerated::eval_oods_polynomial_inner;
    use integrity::air::layouts::starknet_with_keccak::global_values::GlobalValues;
    use starknet::ContractAddress;
