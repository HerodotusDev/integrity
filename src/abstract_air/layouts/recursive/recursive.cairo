use cairo_verifier::{
    abstract_air::{
        layouts::recursive::{
            ...
            public_input::PublicInputRecursiveImpl,
            constants::{
                PUBLIC_MEMORY_STEP, DILUTED_N_BITS, DILUTED_SPACING, PEDERSEN_BUILTIN_RATIO,
                PEDERSEN_BUILTIN_REPETITIONS, segments
            },
        },
        air::AIR, diluted::get_diluted_product, pedersen::{eval_pedersen_x, eval_pedersen_y},
...
impl RecursiveAIRImpl of AIR<Recursive, InteractionElements, PublicInput> {
