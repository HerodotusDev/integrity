...
mod FactRegistry {
    ...
    use cairo_verifier::{verifier::{CairoVerifier, ICairoVerifier, StarkProof}, facts_registry::IFactRegistry};
    ...
    impl FactRegistryImpl of IFactRegistry<ContractState> {
        fn verify_and_register_fact(
            ...
            let (program_hash, output_hash) = self
                .cairo_verifier
                .verify_proof(stark_proof.into(), cairo_version, self.contract_address_1.read(), self.contract_address_2.read());
