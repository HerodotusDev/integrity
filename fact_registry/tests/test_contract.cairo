...
use tests::{get_stark_proof::get_stark_proof, get_stark_proof_with_serde::get_stark_proof_with_serde};
...
fn test_return_false_before_register() {
    ...
    let program_hash = 61181024339325263750486605072532484274138492424367337753502707002347571909007_u256;
